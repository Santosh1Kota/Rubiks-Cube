...
export default function CameraRoutePage() {
  return (
    <CubeProvider>
          ...
          <div className="max-w-6xl mx-auto px-6 py-5">
            <div className="flex items-center justify-between">
              ...
              <div className="flex space-x-6">
                ...
                <span className="px-6 py-3 rounded-xl font-medium bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg shadow-blue-600/25">Camera</span>
                <Link href="/visualizer" className="px-6 py-3 rounded-xl font-medium text-blue-200 hover:text-white hover:bg-blue-800/30 transition">Visualizer</Link>
              </div>
            </div>
          </div>
        </nav>
